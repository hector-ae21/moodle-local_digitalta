...
class external_update_tutor_disponibility extends external_api
{

    public static function update_tutor_disponibility_parameters()
    {
    ...
    public static function update_tutor_disponibility($id, $userid, $day, $timefrom, $timeto)
    {
        try {
            $tutor_disponibility = tutor_disponibility::update($id, $userid, $day, $timefrom, $timeto);
        } catch (\Exception $e) {
    ...
    public static function update_tutor_disponibility_returns()
    {
