 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class external_cases_section_text_upsert extends external_api
{

    public static function cases_section_text_upsert_parameters()
    {
    ...
    public static function cases_section_text_upsert($caseid, $sectionid = 0, $title = "section_body", $text = "", $sequence = 0)
    {
        global $DB;
        ...
        if ($sectionid) {
            ...
            $section->sequence = $DB->get_field('digital_oc_sec_text', 'MAX(sequence)', array('caseid' => $caseid)) + 1;
    ...
    public static function cases_section_text_upsert_returns()
    {
