...
$string['concept:experiences:featured'] = 'Aanbevolen ervaringen';
$string['concept:experiences:recent'] = 'Recente ervaringen';
$string['concept:case']          = 'Zaak';
$string['concept:cases']         = 'Gevallen';
$string['concept:cases:lowercase'] = strtolower($string['concept:cases']);
$string['concept:cases:featured'] = 'Aanbevolen gevallen';
$string['concept:cases:recent'] = 'Recente gevallen';
