...
// Elements - Languages
$string['lang:ab'] = 'Abkhazian';
$string['lang:aa'] = 'Afar';
$string['lang:af'] = 'Afrikaans';
$string['lang:ak'] = 'Akan';
$string['lang:sq'] = 'Albanian';
$string['lang:am'] = 'Amharic';
$string['lang:ar'] = 'Arabic';
$string['lang:an'] = 'Aragonese';
$string['lang:hy'] = 'Armenian';
$string['lang:as'] = 'Assamese';
$string['lang:av'] = 'Avaric';
$string['lang:ae'] = 'Avestan';
$string['lang:ay'] = 'Aymara';
$string['lang:az'] = 'Azerbaijani';
$string['lang:bm'] = 'Bambara';
$string['lang:ba'] = 'Bashkir';
$string['lang:eu'] = 'Basque';
$string['lang:be'] = 'Belarusian';
$string['lang:bn'] = 'Bengali';
$string['lang:bh'] = 'Bihari languages';
$string['lang:bi'] = 'Bislama';
$string['lang:bs'] = 'Bosnian';
$string['lang:br'] = 'Breton';
$string['lang:bg'] = 'Bulgarian';
$string['lang:my'] = 'Burmese';
$string['lang:ca'] = 'Catalan, Valencian';
$string['lang:km'] = 'Central Khmer';
$string['lang:ch'] = 'Chamorro';
$string['lang:ce'] = 'Chechen';
$string['lang:ny'] = 'Chichewa, Chewa, Nyanja';
$string['lang:zh'] = 'Chinese';
$string['lang:cu'] = 'Church Slavonic, Old Bulgarian, Old Church Slavonic';
$string['lang:cv'] = 'Chuvash';
$string['lang:kw'] = 'Cornish';
$string['lang:co'] = 'Corsican';
$string['lang:cr'] = 'Cree';
$string['lang:hr'] = 'Croatian';
$string['lang:cs'] = 'Czech';
$string['lang:da'] = 'Danish';
$string['lang:dv'] = 'Divehi, Dhivehi, Maldivian';
$string['lang:nl'] = 'Dutch, Flemish';
$string['lang:dz'] = 'Dzongkha';
$string['lang:en'] = 'English';
$string['lang:eo'] = 'Esperanto';
$string['lang:et'] = 'Estonian';
$string['lang:ee'] = 'Ewe';
$string['lang:fo'] = 'Faroese';
$string['lang:fj'] = 'Fijian';
$string['lang:fi'] = 'Finnish';
$string['lang:fr'] = 'French';
$string['lang:ff'] = 'Fulah';
$string['lang:gd'] = 'Gaelic, Scottish Gaelic';
$string['lang:gl'] = 'Galician';
$string['lang:lg'] = 'Ganda';
$string['lang:ka'] = 'Georgian';
$string['lang:de'] = 'German';
$string['lang:ki'] = 'Gikuyu, Kikuyu';
$string['lang:el'] = 'Greek (Modern)';
$string['lang:kl'] = 'Greenlandic, Kalaallisut';
$string['lang:gn'] = 'Guarani';
$string['lang:gu'] = 'Gujarati';
$string['lang:ht'] = 'Haitian, Haitian Creole';
$string['lang:ha'] = 'Hausa';
$string['lang:he'] = 'Hebrew';
$string['lang:hz'] = 'Herero';
$string['lang:hi'] = 'Hindi';
$string['lang:ho'] = 'Hiri Motu';
$string['lang:hu'] = 'Hungarian';
$string['lang:is'] = 'Icelandic';
$string['lang:io'] = 'Ido';
$string['lang:ig'] = 'Igbo';
$string['lang:id'] = 'Indonesian';
$string['lang:ia'] = 'Interlingua (International Auxiliary Language Association)';
$string['lang:ie'] = 'Interlingue';
$string['lang:iu'] = 'Inuktitut';
$string['lang:ik'] = 'Inupiaq';
$string['lang:ga'] = 'Irish';
$string['lang:it'] = 'Italian';
$string['lang:ja'] = 'Japanese';
$string['lang:jv'] = 'Javanese';
$string['lang:kn'] = 'Kannada';
$string['lang:kr'] = 'Kanuri';
$string['lang:ks'] = 'Kashmiri';
$string['lang:kk'] = 'Kazakh';
$string['lang:rw'] = 'Kinyarwanda';
$string['lang:kv'] = 'Komi';
$string['lang:kg'] = 'Kongo';
$string['lang:ko'] = 'Korean';
$string['lang:kj'] = 'Kwanyama, Kuanyama';
$string['lang:ku'] = 'Kurdish';
$string['lang:ky'] = 'Kyrgyz';
$string['lang:lo'] = 'Lao';
$string['lang:la'] = 'Latin';
$string['lang:lv'] = 'Latvian';
$string['lang:lb'] = 'Letzeburgesch, Luxembourgish';
$string['lang:li'] = 'Limburgish, Limburgan, Limburger';
$string['lang:ln'] = 'Lingala';
$string['lang:lt'] = 'Lithuanian';
$string['lang:lu'] = 'Luba-Katanga';
$string['lang:mk'] = 'Macedonian';
$string['lang:mg'] = 'Malagasy';
$string['lang:ms'] = 'Malay';
$string['lang:ml'] = 'Malayalam';
$string['lang:mt'] = 'Maltese';
$string['lang:gv'] = 'Manx';
$string['lang:mi'] = 'Maori';
$string['lang:mr'] = 'Marathi';
$string['lang:mh'] = 'Marshallese';
$string['lang:ro'] = 'Moldovan, Moldavian, Romanian';
$string['lang:mn'] = 'Mongolian';
$string['lang:na'] = 'Nauru';
$string['lang:nv'] = 'Navajo, Navaho';
$string['lang:nd'] = 'Northern Ndebele';
$string['lang:ng'] = 'Ndonga';
$string['lang:ne'] = 'Nepali';
$string['lang:se'] = 'Northern Sami';
$string['lang:no'] = 'Norwegian';
$string['lang:nb'] = 'Norwegian Bokmål';
$string['lang:nn'] = 'Norwegian Nynorsk';
$string['lang:ii'] = 'Nuosu, Sichuan Yi';
$string['lang:oc'] = 'Occitan (post 1500)';
$string['lang:oj'] = 'Ojibwa';
$string['lang:or'] = 'Oriya';
$string['lang:om'] = 'Oromo';
$string['lang:os'] = 'Ossetian, Ossetic';
$string['lang:pi'] = 'Pali';
$string['lang:pa'] = 'Panjabi, Punjabi';
$string['lang:ps'] = 'Pashto, Pushto';
$string['lang:fa'] = 'Persian';
$string['lang:pl'] = 'Polish';
$string['lang:pt'] = 'Portuguese';
$string['lang:qu'] = 'Quechua';
$string['lang:rm'] = 'Romansh';
$string['lang:rn'] = 'Rundi';
$string['lang:ru'] = 'Russian';
$string['lang:sm'] = 'Samoan';
$string['lang:sg'] = 'Sango';
$string['lang:sa'] = 'Sanskrit';
$string['lang:sc'] = 'Sardinian';
$string['lang:sr'] = 'Serbian';
$string['lang:sn'] = 'Shona';
$string['lang:sd'] = 'Sindhi';
$string['lang:si'] = 'Sinhala, Sinhalese';
$string['lang:sk'] = 'Slovak';
$string['lang:sl'] = 'Slovenian';
$string['lang:so'] = 'Somali';
$string['lang:st'] = 'Sotho, Southern';
$string['lang:nr'] = 'South Ndebele';
$string['lang:es'] = 'Spanish, Castilian';
$string['lang:su'] = 'Sundanese';
$string['lang:sw'] = 'Swahili';
$string['lang:ss'] = 'Swati';
$string['lang:sv'] = 'Swedish';
$string['lang:tl'] = 'Tagalog';
$string['lang:ty'] = 'Tahitian';
$string['lang:tg'] = 'Tajik';
$string['lang:ta'] = 'Tamil';
$string['lang:tt'] = 'Tatar';
$string['lang:te'] = 'Telugu';
$string['lang:th'] = 'Thai';
$string['lang:bo'] = 'Tibetan';
$string['lang:ti'] = 'Tigrinya';
$string['lang:to'] = 'Tonga (Tonga Islands)';
$string['lang:ts'] = 'Tsonga';
$string['lang:tn'] = 'Tswana';
$string['lang:tr'] = 'Turkish';
$string['lang:tk'] = 'Turkmen';
$string['lang:tw'] = 'Twi';
$string['lang:ug'] = 'Uighur, Uyghur';
$string['lang:uk'] = 'Ukrainian';
$string['lang:ur'] = 'Urdu';
$string['lang:uz'] = 'Uzbek';
$string['lang:ve'] = 'Venda';
$string['lang:vi'] = 'Vietnamese';
$string['lang:vo'] = 'Volap_k';
$string['lang:wa'] = 'Walloon';
$string['lang:cy'] = 'Welsh';
$string['lang:fy'] = 'Western Frisian';
$string['lang:wo'] = 'Wolof';
$string['lang:xh'] = 'Xhosa';
$string['lang:yi'] = 'Yiddish';
