...
$continueurl = new moodle_url('/local/dta/pages/experience/delete.php', array('id' => $experience->id, 'delete' => md5($experience->date)));
$backurl = new moodle_url('/local/dta/pages/profile.php');
